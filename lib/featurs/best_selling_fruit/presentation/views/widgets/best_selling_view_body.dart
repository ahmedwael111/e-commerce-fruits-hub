...
class BestSellingViewBodyBlocBuiler extends StatelessWidget {
  const BestSellingViewBodyBlocBuiler({super.key});
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<ProductsCubit, ProductsState>(
      builder: (context, state) {
        ...
        return Skeletonizer(child: ProductsGridview(products: dummyProducts()));
      },
    );
  }
}
